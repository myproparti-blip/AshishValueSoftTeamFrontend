...
const BOfMaharastraEditForm = ({ user, onLogin }) => {
    ...
    const handleDownloadPDF = async () => {
        try {
            ...
            try {
                ...
                console.log('✅ Fresh BOF Maharashtra data fetched for PDF:', {
    ...
    const handleSave = async () => {
        try {
            dispatch(showLoader());
            await updateBofMaharashtra(id, formData, user.username, user.role, user.clientId);
            invalidateCache();
            dispatch(hideLoader());
    ...
    const onFinish = async (e) => {
        ...
        try {
            ...
            console.log("[bomflat.jsx] Payload being sent to API:", {
